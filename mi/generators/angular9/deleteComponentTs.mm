...
<node CREATED="1684094474151" ID="ID_84120671" LINK="../../mapperidea.mm" MODIFIED="1689282469537" TEXT="deleteComponentTs">
...
<node CREATED="1533601526261" FOLDED="true" ID="ID_1635539125" MODIFIED="1592524043912" POSITION="right" TEXT="vars">
<icon BUILTIN="element"/>
<node CREATED="1666405824457" FOLDED="true" ID="ID_317876847" MODIFIED="1684435583313" TEXT="angularTypes">
<icon BUILTIN="element"/>
...
<node CREATED="1684262550083" ID="ID_484366000" MODIFIED="1689276550531" TEXT="import { ActivatedRoute, Router } from &apos;@angular/router&apos;;">
<icon BUILTIN="tag_green"/>
</node>
</node>
...
<node CREATED="1684780378519" ID="ID_514498234" MODIFIED="1684957037646" TEXT="class">
<icon BUILTIN="Descriptor.grouping"/>
...
<node CREATED="1684781796738" ID="ID_1598098590" MODIFIED="1689279261579" TEXT="variables">
<icon BUILTIN="Descriptor.grouping"/>
<node CREATED="1689867607571" ID="ID_693764309" MODIFIED="1689878755789" TEXT="object">
<icon BUILTIN="element"/>
...
<node CREATED="1689879205685" ID="ID_411550101" MODIFIED="1689879206985" TEXT="">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1684846686677" ID="ID_1104271451" MODIFIED="1684846689565" TEXT="attribute">
<icon BUILTIN="Descriptor.grouping"/>
...
<node CREATED="1684847295219" FOLDED="true" ID="ID_876405174" MODIFIED="1684847307951" TEXT="constructor">
<icon BUILTIN="Descriptor.grouping"/>
...
<node CREATED="1684847928583" FOLDED="true" ID="ID_1258764223" MODIFIED="1684848327791" TEXT="functions">
<icon BUILTIN="Descriptor.grouping"/>
<node CREATED="1684848471012" FOLDED="true" ID="ID_836815585" MODIFIED="1689192969550" TEXT="ngOnInit">
<icon BUILTIN="Descriptor.grouping"/>
...
<node CREATED="1689102613844" FOLDED="true" ID="ID_407422781" MODIFIED="1689261260672" TEXT="callFunctionRead-oneToOne-init">
<icon BUILTIN="element"/>
...
<node CREATED="1689261059457" FOLDED="true" ID="ID_383355530" MODIFIED="1689261067044" TEXT="callFunctionRead-oneToOne-find ">
<icon BUILTIN="element"/>
...
<node CREATED="1689102613844" FOLDED="true" ID="ID_111986923" MODIFIED="1689261093718" TEXT="callFunctionRead-oneToOne-end">
<icon BUILTIN="element"/>
...
<node CREATED="1689266923577" FOLDED="true" ID="ID_1749975681" MODIFIED="1689266931125" TEXT="gridControlVariable">
<icon BUILTIN="element"/>
<node CREATED="1689266943634" ID="ID_1220329379" MODIFIED="1689282122034" TEXT="      this.dataSource{{ mi:first-upper($attributeName) }}.data = this.{{ mi:first-lower($objetoClassName) }}.{{ mi:first-lower($attributeName) }};">
<icon BUILTIN="tag_green"/>
</node>
</node>
</node>
<node CREATED="1684848544633" FOLDED="true" ID="ID_227906279" MODIFIED="1684958089255" TEXT="deleteObject">
<icon BUILTIN="element"/>
<node CREATED="1684848576384" FOLDED="true" ID="ID_931696680" MODIFIED="1684848579312" TEXT="init">
<icon BUILTIN="Descriptor.grouping"/>
<node CREATED="1684848567576" ID="ID_1435105384" MODIFIED="1689280894741" TEXT="  delete{{ mi:first-upper($objetoClass/@name) }}()">
<icon BUILTIN="tag_yellow"/>
</node>
<node CREATED="1684848619336" ID="ID_1832279630" MODIFIED="1684848620762" TEXT=": void {">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1684848581332" FOLDED="true" ID="ID_1910852486" MODIFIED="1684848583384" TEXT="body">
<icon BUILTIN="Descriptor.grouping"/>
<node CREATED="1684848660221" ID="ID_79787040" MODIFIED="1689280921144" TEXT="    this.{{ mi:first-lower($objetoClass/@name) }}Service.delete(this.{{ mi:first-lower($objetoClass/@name) }}.{{ $objetoClass/properties/id/column/value/text() }}.toString()).subscribe(">
<icon BUILTIN="tag_green"/>
</node>
<node CREATED="1684848674181" ID="ID_1001959937" MODIFIED="1684958457555" TEXT="      () =&gt; {">
<icon BUILTIN="tag_green"/>
</node>
<node CREATED="1684848750963" ID="ID_8284278" MODIFIED="1689280933661" TEXT="        this.{{ mi:first-lower($objetoClass/@name) }}Service.showMessage(&apos;{{ $objetoClass/properties/description/value }} excluido!&apos;);">
<icon BUILTIN="tag_green"/>
</node>
<node CREATED="1684849057371" ID="ID_352548422" MODIFIED="1689281019965" TEXT="        this.router.navigate([&apos;/{{ mi:first-lower(@name) }}&apos;]);">
<icon BUILTIN="tag_green"/>
</node>
...
<node CREATED="1684848584068" FOLDED="true" ID="ID_456603671" MODIFIED="1684848586848" TEXT="end">
<icon BUILTIN="Descriptor.grouping"/>
...
<node CREATED="1684849397109" FOLDED="true" ID="ID_226935659" MODIFIED="1684849401178" TEXT="cancel">
<icon BUILTIN="element"/>
<node CREATED="1684848576384" FOLDED="true" ID="ID_1821190736" MODIFIED="1684848579312" TEXT="init">
<icon BUILTIN="Descriptor.grouping"/>
<node CREATED="1684849419320" MODIFIED="1684849423865" TEXT="  cancel(): void {">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1684848581332" FOLDED="true" ID="ID_1328706941" MODIFIED="1684848583384" TEXT="body">
<icon BUILTIN="Descriptor.grouping"/>
<node CREATED="1684849431985" ID="ID_887352707" MODIFIED="1689281008019" TEXT="    this.router.navigate([&apos;/{{ mi:first-lower(@name) }}&apos;]);">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1684848584068" FOLDED="true" ID="ID_1198045446" MODIFIED="1684848586848" TEXT="end">
<icon BUILTIN="Descriptor.grouping"/>
...
<icon BUILTIN="element"/>
<node CREATED="1689087216236" ID="ID_491205774" MODIFIED="1689279395040" TEXT="];">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1689088185925" FOLDED="true" ID="ID_1850156984" MODIFIED="1689088198904" TEXT="displayedColumns-item">
<icon BUILTIN="element"/>
<node CREATED="1689088219520" ID="ID_1613082294" MODIFIED="1689279757126" TEXT="&apos;{{ mi:first-lower($attributeName) }}&apos;">
<icon BUILTIN="tag_yellow"/>
</node>
</node>
...
<node CREATED="1684329909851" FOLDED="true" ID="ID_1248596667" MODIFIED="1684329912201" TEXT="generic">
<icon BUILTIN="Descriptor.grouping"/>
<node CREATED="1684184846095" FOLDED="true" ID="ID_1995426080" MODIFIED="1684184850914" TEXT="breakLine">
<icon BUILTIN="element"/>
<node CREATED="1684184851927" MODIFIED="1684184853603" TEXT="">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1684846805696" FOLDED="true" ID="ID_1061160043" MODIFIED="1684846844703" TEXT="comma">
<icon BUILTIN="element"/>
<node CREATED="1684846845606" MODIFIED="1684846847159" TEXT=",">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1689279762808" FOLDED="true" ID="ID_1058796622" MODIFIED="1689279771289" TEXT="commaNoBreak">
<icon BUILTIN="element"/>
<node CREATED="1689279772357" ID="ID_1875045858" MODIFIED="1689279774156" TEXT=", ">
<icon BUILTIN="tag_yellow"/>
</node>
</node>
</node>
...
<node CREATED="1684160926435" ID="ID_1256167864" MODIFIED="1684160965104" POSITION="right" TEXT="start">
<icon BUILTIN="element"/>
<node CREATED="1684160926436" FOLDED="true" ID="ID_417537278" MODIFIED="1684160972183" TEXT="match">
<icon BUILTIN="element"/>
<node CREATED="1684160926437" MODIFIED="1684261640840" TEXT="/classes/class[@name = $className and @package = $packageName]">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1684160926438" ID="ID_593864477" MODIFIED="1684160972182" TEXT="body">
<icon BUILTIN="element"/>
<node CREATED="1684262665910" FOLDED="true" ID="ID_678751304" MODIFIED="1684778698496" TEXT="vars">
<icon BUILTIN="element"/>
...
<node CREATED="1684262732468" FOLDED="true" ID="ID_150332620" MODIFIED="1684262733608" TEXT="var">
<icon BUILTIN="element"/>
...
<node CREATED="1684781534061" ID="ID_855090284" MODIFIED="1684781540901" TEXT="if">
<icon BUILTIN="element"/>
<node CREATED="1684781554993" ID="ID_179091685" MODIFIED="1684781563017" TEXT="exists($objetoClass)">
<icon BUILTIN="tag_green"/>
</node>
<node CREATED="1684781563589" ID="ID_1295417366" MODIFIED="1684781564946" TEXT="then">
<icon BUILTIN="element"/>
<node CREATED="1684262349505" FOLDED="true" ID="ID_248919808" MODIFIED="1684262351997" TEXT="import">
<icon BUILTIN="Descriptor.grouping"/>
<node CREATED="1684160926441" FOLDED="true" ID="ID_1775162741" MODIFIED="1684183288218" TEXT="apply-templates">
<icon BUILTIN="element"/>
<node CREATED="1684160926442" FOLDED="true" ID="ID_47562343" MODIFIED="1684161075329" TEXT="select">
<icon BUILTIN="element"/>
<node CREATED="1684161082942" MODIFIED="1684262392914" TEXT=".">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1650400304939" FOLDED="true" ID="ID_613008777" MODIFIED="1684263192314" TEXT="parameters">
<icon BUILTIN="element"/>
<node CREATED="1650400304940" FOLDED="true" ID="ID_1371635691" MODIFIED="1684595584425" TEXT="objetoClass">
<icon BUILTIN="element"/>
<node CREATED="1650400304940" FOLDED="true" ID="ID_589378820" MODIFIED="1684263201660" TEXT="expr">
<icon BUILTIN="element"/>
...
<node CREATED="1684160926444" FOLDED="true" ID="ID_1400312387" MODIFIED="1684161075329" TEXT="mode">
<icon BUILTIN="element"/>
...
<node CREATED="1671891592531" FOLDED="true" ID="ID_1187187851" MODIFIED="1684330032074" TEXT="write-pattern">
<icon BUILTIN="element"/>
...
<node CREATED="1684779266418" ID="ID_1414442713" MODIFIED="1684956787841" TEXT="Component">
<icon BUILTIN="Descriptor.grouping"/>
<node CREATED="1671891592531" FOLDED="true" ID="ID_1344339344" MODIFIED="1684330032074" TEXT="write-pattern">
<icon BUILTIN="element"/>
...
<node CREATED="1684780340387" ID="ID_1930061303" MODIFIED="1684780344855" TEXT="class">
<icon BUILTIN="Descriptor.grouping"/>
<node CREATED="1671891592531" ID="ID_953273551" MODIFIED="1684330032074" TEXT="write-pattern">
<icon BUILTIN="element"/>
<node CREATED="1684329951687" MODIFIED="1684780364235" TEXT="class-init">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1684781476620" ID="ID_512859730" MODIFIED="1689277296896" TEXT="variables">
<icon BUILTIN="Descriptor.grouping"/>
<node CREATED="1684160926441" ID="ID_1726493313" MODIFIED="1684781473946" TEXT="apply-templates">
<icon BUILTIN="element"/>
<node CREATED="1684160926442" ID="ID_195661946" MODIFIED="1684161075329" TEXT="select">
<icon BUILTIN="element"/>
<node CREATED="1684263206930" MODIFIED="1684595673455" TEXT="$objetoClass">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1684160926444" ID="ID_1835616112" MODIFIED="1684161075329" TEXT="mode">
<icon BUILTIN="element"/>
...
<node CREATED="1684847043907" ID="ID_1462863412" MODIFIED="1684957520151" TEXT="constructor">
<icon BUILTIN="Descriptor.grouping"/>
<node CREATED="1684160926441" ID="ID_272978065" MODIFIED="1684781473946" TEXT="apply-templates">
<icon BUILTIN="element"/>
<node CREATED="1684160926442" ID="ID_1243726331" MODIFIED="1684161075329" TEXT="select">
<icon BUILTIN="element"/>
<node CREATED="1684263206930" MODIFIED="1684595673455" TEXT="$objetoClass">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1684160926444" ID="ID_253211942" MODIFIED="1684161075329" TEXT="mode">
<icon BUILTIN="element"/>
...
<node CREATED="1684847928583" ID="ID_1181752397" MODIFIED="1684847933207" TEXT="functions">
<icon BUILTIN="Descriptor.grouping"/>
<node CREATED="1684160926441" ID="ID_1791319536" MODIFIED="1684781473946" TEXT="apply-templates">
<icon BUILTIN="element"/>
<node CREATED="1684160926442" ID="ID_1025206432" MODIFIED="1684161075329" TEXT="select">
<icon BUILTIN="element"/>
<node CREATED="1684263206930" ID="ID_965923876" MODIFIED="1689281075729" TEXT=".">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1650400304939" ID="ID_134558330" MODIFIED="1684848166961" TEXT="parameters">
<icon BUILTIN="element"/>
...
<node CREATED="1684160926444" ID="ID_970281127" MODIFIED="1684161075329" TEXT="mode">
<icon BUILTIN="element"/>
...
<node CREATED="1671891592531" ID="ID_1810116296" MODIFIED="1684330032074" TEXT="write-pattern">
<icon BUILTIN="element"/>
...
<node CREATED="1684846260067" ID="ID_1146663075" MODIFIED="1689277284576" TEXT="variables">
<icon BUILTIN="Descriptor.grouping"/>
...
<icon BUILTIN="element"/>
<node CREATED="1671891592531" ID="ID_1671659822" MODIFIED="1689878617617" TEXT="write-pattern">
<icon BUILTIN="element"/>
...
<node CREATED="1689878587426" ID="ID_154096935" MODIFIED="1689878588325" TEXT="//">
...
<node CREATED="1560170966257" ID="ID_163267357" MODIFIED="1689277660206" TEXT="parameters">
<icon BUILTIN="element"/>
<node CREATED="1560170976556" ID="ID_803487456" MODIFIED="1689184713218" TEXT="level">
<icon BUILTIN="element"/>
...
<node CREATED="1686949975235" ID="ID_1676873985" MODIFIED="1686950011514" TEXT="else-if">
<icon BUILTIN="element"/>
...
<node CREATED="1686950023667" ID="ID_1692526842" MODIFIED="1686950025109" TEXT="then">
<icon BUILTIN="element"/>
<node CREATED="1671891592531" ID="ID_315544121" MODIFIED="1684846638581" TEXT="write-pattern">
<icon BUILTIN="element"/>
...
<icon BUILTIN="element"/>
<node CREATED="1685988358165" ID="ID_1034173957" MODIFIED="1685988360881" TEXT="if">
<icon BUILTIN="element"/>
<node CREATED="1685988372209" ID="ID_1491335633" MODIFIED="1685988384365" TEXT="@mode = &quot;oneToOne&quot;">
<icon BUILTIN="tag_green"/>
</node>
<node CREATED="1685988384898" ID="ID_905539452" MODIFIED="1685988386191" TEXT="then">
<icon BUILTIN="element"/>
<node CREATED="1671891592531" ID="ID_1586057236" MODIFIED="1684330032074" TEXT="write-pattern">
<icon BUILTIN="element"/>
...
<node CREATED="1685988434582" ID="ID_1885347213" MODIFIED="1685988438196" TEXT="else-if">
<icon BUILTIN="element"/>
<node CREATED="1685988372209" ID="ID_1229554769" MODIFIED="1685988449622" TEXT="@mode = &quot;oneToMany&quot;">
<icon BUILTIN="tag_green"/>
</node>
<node CREATED="1685988444043" ID="ID_1064036254" MODIFIED="1685988445288" TEXT="then">
<icon BUILTIN="element"/>
<node CREATED="1671891592531" ID="ID_1404453883" MODIFIED="1684330032074" TEXT="write-pattern">
<icon BUILTIN="element"/>
...
<node CREATED="1685988387770" ID="ID_742686758" MODIFIED="1685988388936" TEXT="else">
<icon BUILTIN="element"/>
...
<node CREATED="1684262412441" ID="ID_167770556" MODIFIED="1684846264154" TEXT="mode">
<icon BUILTIN="element"/>
...
<icon BUILTIN="element"/>
<node CREATED="1684161945113" ID="ID_1743543769" MODIFIED="1684162091243" TEXT="match">
<icon BUILTIN="element"/>
<node CREATED="1689086216875" ID="ID_1267985206" MODIFIED="1689086224783" TEXT="class">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1560170966257" ID="ID_551712960" MODIFIED="1689086367692" TEXT="parameters">
<icon BUILTIN="element"/>
<node CREATED="1688665220027" ID="ID_1584897475" MODIFIED="1688742433702" TEXT="attributeName">
<icon BUILTIN="element"/>
...
<node CREATED="1671891592531" ID="ID_629561549" MODIFIED="1689096783759" TEXT="write-pattern">
<icon BUILTIN="element"/>
<node CREATED="1684846805696" MODIFIED="1684846820372" TEXT="breakLine">
<icon BUILTIN="tag_green"/>
</node>
...
<node CREATED="1689085990771" ID="ID_564315778" MODIFIED="1689085993460" TEXT="mode">
<icon BUILTIN="element"/>
<node CREATED="1689087903225" ID="ID_1298061401" MODIFIED="1689087989664" TEXT="displayedColumns_item">
<icon BUILTIN="tag_green"/>
</node>
<node CREATED="1684161945112" ID="ID_1584726787" MODIFIED="1684162080080" TEXT="template">
<icon BUILTIN="element"/>
<node CREATED="1684161945113" ID="ID_168921906" MODIFIED="1684162091243" TEXT="match">
<icon BUILTIN="element"/>
<node CREATED="1689088124979" ID="ID_801494103" MODIFIED="1689088126760" TEXT="field">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1684161945118" ID="ID_1052319870" MODIFIED="1684162091242" TEXT="body">
<icon BUILTIN="element"/>
<node CREATED="1689088165921" ID="ID_1269548564" MODIFIED="1689088169131" TEXT="vars">
<icon BUILTIN="element"/>
<node CREATED="1684602801348" ID="ID_1961107221" MODIFIED="1684602804116" TEXT="var">
<icon BUILTIN="element"/>
<node CREATED="1684602818097" ID="ID_784709776" MODIFIED="1684602823477" TEXT="attributeName">
<icon BUILTIN="tag_green"/>
</node>
<node CREATED="1684602824521" ID="ID_940263484" MODIFIED="1684602826334" TEXT="expr">
<icon BUILTIN="element"/>
<node CREATED="1684602864119" MODIFIED="1684602883975" TEXT="substring(value/text(), 2)">
<icon BUILTIN="tag_green"/>
</node>
...
<node CREATED="1671891592531" ID="ID_268487056" MODIFIED="1684846624463" TEXT="write-pattern">
<icon BUILTIN="element"/>
<node CREATED="1689087903225" ID="ID_1475236072" MODIFIED="1689088206336" TEXT="displayedColumns-item">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1689279800818" ID="ID_924014046" MODIFIED="1689279803630" TEXT="if">
<icon BUILTIN="element"/>
<node CREATED="1689279804380" ID="ID_982190933" MODIFIED="1689279815527" TEXT="last() != position()">
<icon BUILTIN="tag_green"/>
</node>
<node CREATED="1689279816454" ID="ID_1635360608" MODIFIED="1689279820564" TEXT="then">
<icon BUILTIN="element"/>
<node CREATED="1671891592531" ID="ID_741214642" MODIFIED="1684846624463" TEXT="write-pattern">
<icon BUILTIN="element"/>
<node CREATED="1689279821700" ID="ID_761260531" MODIFIED="1689279834232" TEXT="commaNoBreak">
<icon BUILTIN="tag_green"/>
</node>
</node>
</node>
...
<node CREATED="1684847928583" FOLDED="true" ID="ID_1402649699" MODIFIED="1684848327791" TEXT="functions">
<icon BUILTIN="Descriptor.grouping"/>
<node CREATED="1684262412441" FOLDED="true" ID="ID_13315660" MODIFIED="1684846264154" TEXT="mode">
<icon BUILTIN="element"/>
<node CREATED="1684847093136" ID="ID_1001493036" MODIFIED="1684848159210" TEXT="functions">
<icon BUILTIN="tag_green"/>
</node>
<node CREATED="1684161945112" FOLDED="true" ID="ID_1701833194" MODIFIED="1684162080080" TEXT="template">
<icon BUILTIN="element"/>
<node CREATED="1684161945113" FOLDED="true" ID="ID_1830145618" MODIFIED="1684162091243" TEXT="match">
<icon BUILTIN="element"/>
<node CREATED="1684781727710" MODIFIED="1684781730667" TEXT="class">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1560170966257" FOLDED="true" ID="ID_1446015038" MODIFIED="1684848410628" TEXT="parameters">
<icon BUILTIN="element"/>
<node CREATED="1560170976556" FOLDED="true" ID="ID_130871947" MODIFIED="1684595557121" TEXT="objetoClass">
<icon BUILTIN="element"/>
...
<node CREATED="1684161945118" FOLDED="true" ID="ID_11057865" MODIFIED="1684162091242" TEXT="body">
<icon BUILTIN="element"/>
<node CREATED="1689101656562" FOLDED="true" ID="ID_271174156" MODIFIED="1689193210623" TEXT="ngOnInit">
<icon BUILTIN="Descriptor.grouping"/>
...
<node CREATED="1689253576434" FOLDED="true" ID="ID_1498846211" MODIFIED="1689253582485" TEXT="functions read">
<icon BUILTIN="Descriptor.grouping"/>
...
<node CREATED="1671891592531" FOLDED="true" ID="ID_1545078802" MODIFIED="1684330032074" TEXT="write-pattern">
<icon BUILTIN="element"/>
<node CREATED="1684848443064" MODIFIED="1684958080634" TEXT="deleteObject">
<icon BUILTIN="tag_green"/>
</node>
</node>
<node CREATED="1671891592531" FOLDED="true" ID="ID_519753886" MODIFIED="1684330032074" TEXT="write-pattern">
<icon BUILTIN="element"/>
...
<node CREATED="1689260665053" FOLDED="true" ID="ID_1306815547" MODIFIED="1689260666600" TEXT="if">
<icon BUILTIN="element"/>
<node CREATED="1689260682120" ID="ID_1309649974" MODIFIED="1689261004267" TEXT="$objetoClass/@name = $objetoClassName">
<icon BUILTIN="tag_green"/>
</node>
<node CREATED="1689261004947" FOLDED="true" ID="ID_298933477" MODIFIED="1689261007685" TEXT="then">
<icon BUILTIN="element"/>
<node CREATED="1671891592531" FOLDED="true" ID="ID_147091994" MODIFIED="1684846624463" TEXT="write-pattern">
<icon BUILTIN="element"/>
...
<node CREATED="1671891592531" FOLDED="true" ID="ID_883920830" MODIFIED="1684846624463" TEXT="write-pattern">
<icon BUILTIN="element"/>
...
<node CREATED="1671891592531" FOLDED="true" ID="ID_1848359056" MODIFIED="1689266732450" TEXT="write-pattern">
<icon BUILTIN="element"/>
