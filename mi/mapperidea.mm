...
<icon BUILTIN="element"/>
<node CREATED="1684262492584" ID="ID_242776371" MODIFIED="1684262493959" TEXT="import">
<icon BUILTIN="Descriptor.grouping"/>
...
<node CREATED="1684263845607" ID="ID_110917283" MODIFIED="1684263910080" TEXT="{{ mi:first-lower($classObjeto/@name) }}.model&apos;;">
<icon BUILTIN="tag_green"/>
</node>
<node CREATED="1684263952075" ID="ID_1751283165" MODIFIED="1684263973502" TEXT="//MRN _ tem que analisar se vai ficar assim mesmo, ou pegar o nome do service do mapa de tela"/>
</node>
</node>
</node>
